...
static double __pyx_f_8py_ymw16_distance(double __pyx_v_l, double __pyx_v_b, double __pyx_v_DM, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_8py_ymw16_distance *__pyx_optional_args) {
  ...
  int __pyx_v_vbs = ((int)0);
  char *__pyx_v_dirname = ((char *)((char *)"./ymw16_v1.3/"));
  char *__pyx_v_text;
  double __pyx_r;
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_DM_Host = __pyx_optional_args->DM_Host;
      if (__pyx_optional_args->__pyx_n > 1) {
        __pyx_v_ndir = __pyx_optional_args->ndir;
        if (__pyx_optional_args->__pyx_n > 2) {
          __pyx_v__np = __pyx_optional_args->_np;
          if (__pyx_optional_args->__pyx_n > 3) {
            __pyx_v_vbs = __pyx_optional_args->vbs;
            if (__pyx_optional_args->__pyx_n > 4) {
              __pyx_v_dirname = __pyx_optional_args->dirname;
            }
          }
        }
      }
...
static PyObject *__pyx_pw_8py_ymw16_1distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_l,&__pyx_n_s_b,&__pyx_n_s_DM,&__pyx_n_s_DM_Host,&__pyx_n_s_ndir,&__pyx_n_s_np,&__pyx_n_s_vbs,&__pyx_n_s_dirname,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("distance", 0, 3, 8, 1); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_DM)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("distance", 0, 3, 8, 2); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_DM_Host);
          if (value) { values[3] = value; kw_args--; }
        }
        case  4:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ndir);
        ...
        case  6:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vbs);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "distance") < 0)) __PYX_ERR(0, 22, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_l = __pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_l == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
    __pyx_v_b = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
    __pyx_v_DM = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_DM == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_DM_Host = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_DM_Host == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L3_error)
    } else {
      __pyx_v_DM_Host = ((double)0.0);
    }
    if (values[4]) {
      __pyx_v_ndir = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_ndir == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    } else {
      __pyx_v_ndir = ((int)1);
    }
    if (values[5]) {
      __pyx_v__np = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v__np == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    } else {
      __pyx_v__np = ((int)1);
    }
    if (values[6]) {
      __pyx_v_vbs = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_vbs == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    } else {
      __pyx_v_vbs = ((int)0);
    }
    if (values[7]) {
      __pyx_v_dirname = __Pyx_PyObject_AsString(values[7]); if (unlikely((!__pyx_v_dirname) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    } else {
      __pyx_v_dirname = ((char *)((char *)"./ymw16_v1.3/"));
    }
  }
...
static PyObject *__pyx_pf_8py_ymw16_distance(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_l, double __pyx_v_b, double __pyx_v_DM, double __pyx_v_DM_Host, int __pyx_v_ndir, int __pyx_v__np, int __pyx_v_vbs, char *__pyx_v_dirname) {
  ...
  __pyx_t_2.__pyx_n = 5;
  __pyx_t_2.DM_Host = __pyx_v_DM_Host;
  __pyx_t_2.ndir = __pyx_v_ndir;
 ...
 *   cdef Py_ssize_t iN ;
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_l, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyObject_Length(__pyx_t_1); if (unlikely(__pyx_t_2 == -1)) __PYX_ERR(0, 70, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_np_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  if (!__pyx_t_5) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_1);
  } else {
    #if CYTHON_FAST_PYCALL
 ...
 *               dirname=dirname) ;
 */
          __pyx_t_9 = __pyx_v_iN;
          __pyx_t_10 = -1;
          if (__pyx_t_9 < 0) {
            __pyx_t_9 += __pyx_v_l.shape[0];
            if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 0;
          } else if (unlikely(__pyx_t_9 >= __pyx_v_l.shape[0])) __pyx_t_10 = 0;
          if (unlikely(__pyx_t_10 != -1)) {
            __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_10);
            __PYX_ERR(0, 76, __pyx_L4_error)
          }
          __pyx_t_11 = __pyx_v_iN;
          __pyx_t_10 = -1;
          if (__pyx_t_11 < 0) {
            __pyx_t_11 += __pyx_v_b.shape[0];
            if (unlikely(__pyx_t_11 < 0)) __pyx_t_10 = 0;
          } else if (unlikely(__pyx_t_11 >= __pyx_v_b.shape[0])) __pyx_t_10 = 0;
          if (unlikely(__pyx_t_10 != -1)) {
            __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_10);
            __PYX_ERR(0, 76, __pyx_L4_error)
          }
          __pyx_t_12 = __pyx_v_iN;
          __pyx_t_10 = -1;
          if (__pyx_t_12 < 0) {
            __pyx_t_12 += __pyx_v_DM.shape[0];
            if (unlikely(__pyx_t_12 < 0)) __pyx_t_10 = 0;
          } else if (unlikely(__pyx_t_12 >= __pyx_v_DM.shape[0])) __pyx_t_10 = 0;
          if (unlikely(__pyx_t_10 != -1)) {
            __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_10);
            __PYX_ERR(0, 76, __pyx_L4_error)
          }
 ...
 */
          ...
          __pyx_t_14.DM_Host = __pyx_v_DM_Host;
          __pyx_t_14.ndir = __pyx_v_ndir;
 ...
 *               dirname=dirname) ;
 */
          __pyx_t_15 = __pyx_v_iN;
          __pyx_t_10 = -1;
          if (__pyx_t_15 < 0) {
            __pyx_t_15 += __pyx_v_D.shape[0];
            if (unlikely(__pyx_t_15 < 0)) __pyx_t_10 = 0;
          } else if (unlikely(__pyx_t_15 >= __pyx_v_D.shape[0])) __pyx_t_10 = 0;
          if (unlikely(__pyx_t_10 != -1)) {
            __Pyx_RaiseBufferIndexErrorNogil(__pyx_t_10);
            __PYX_ERR(0, 76, __pyx_L4_error)
          }
          *((double *) ( /* dim=0 */ (__pyx_v_D.data + __pyx_t_15 * __pyx_v_D.strides[0]) )) = __pyx_t_13;
        }
      }
...
static PyObject *__pyx_pw_8py_ymw16_3distances(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("distances (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("distances", 0, 3, 8, 1); __PYX_ERR(0, 49, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_DM)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("distances", 0, 3, 8, 2); __PYX_ERR(0, 49, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_DM_Host);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "distances") < 0)) __PYX_ERR(0, 49, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  8: values[7] = PyTuple_GET_ITEM(__pyx_args, 7);
    ...
    __pyx_v_l = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_l.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1]); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_DM = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_DM.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_DM_Host = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_DM_Host == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
    } else {
      __pyx_v_DM_Host = ((double)0.0);
    }
    if (values[4]) {
      __pyx_v_ndir = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_ndir == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
    } else {
      __pyx_v_ndir = ((int)1);
    }
    if (values[5]) {
      __pyx_v__np = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v__np == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
    } else {
      __pyx_v__np = ((int)1);
    }
    if (values[6]) {
      __pyx_v_vbs = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_vbs == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L3_error)
    } else {
      __pyx_v_vbs = ((int)0);
    }
    if (values[7]) {
      __pyx_v_dirname = __Pyx_PyObject_AsString(values[7]); if (unlikely((!__pyx_v_dirname) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    } else {
      __pyx_v_dirname = ((char *)((char *)"./ymw16_v1.3/"));
    }
  }
...
static PyObject *__pyx_pf_8py_ymw16_2distances(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_l, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_DM, double __pyx_v_DM_Host, int __pyx_v_ndir, int __pyx_v__np, int __pyx_v_vbs, char *__pyx_v_dirname) {
  ...
  __Pyx_RefNannySetupContext("distances", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_l.memview)) { __Pyx_RaiseUnboundLocalError("l"); __PYX_ERR(0, 49, __pyx_L1_error) }
  if (unlikely(!__pyx_v_b.memview)) { __Pyx_RaiseUnboundLocalError("b"); __PYX_ERR(0, 49, __pyx_L1_error) }
  if (unlikely(!__pyx_v_DM.memview)) { __Pyx_RaiseUnboundLocalError("DM"); __PYX_ERR(0, 49, __pyx_L1_error) }
  __pyx_t_2.__pyx_n = 5;
  __pyx_t_2.DM_Host = __pyx_v_DM_Host;
  __pyx_t_2.ndir = __pyx_v_ndir;
  __pyx_t_2._np = __pyx_v__np;
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpy_ymw16(void); /*proto*/
PyMODINIT_FUNC initpy_ymw16(void)
#else
PyMODINIT_FUNC PyInit_py_ymw16(void); /*proto*/
PyMODINIT_FUNC PyInit_py_ymw16(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_py_ymw16(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("py_ymw16", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
